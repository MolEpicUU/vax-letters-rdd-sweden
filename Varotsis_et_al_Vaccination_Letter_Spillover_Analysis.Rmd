...
file_to_import <- "//micro.intra/projekt/P1224$/P1224_Gem/Yorgo/Files_generated/Spillover_data_Uppsala_20240313.csv"
county_code <- 3
...
main_data_tbl_logit <- main_data_tbl_logit %>% 
  ...
  mutate_at(c('Foreign_vs_Sweden','Letter_received_logreg','Education','sex', 'Ind_slr_cat'), as.factor)
...
model_simple_Kernels_Country <- svyglm(Vax_within_90  ~ Letter_received +  bs(age_formula_influencer ,knots = 49.5, degree = 1) + Foreign_vs_Sweden + Foreign_vs_Sweden:Letter_received,
...
model_interaction_Education_for_Robust <- car::linearHypothesis(model_simple_Kernels_Country,
                                                                c(
...
pvalue_interaction_country_for_Robust_sweden <- model_interaction_Education_for_Robust[2,'Pr(>Chisq)']
...
model_simple_Kernels_Country_Abroad_High_design <- svydesign(id = ~ 1, data = main_data_tbl_logit %>% 
                                                             ...
                                                             weights =  ~ weights_4_model) 
model_simple_Kernels_Country_Abroad_High <- svyglm(Vax_within_90  ~ Letter_received +  bs(age_formula_influencer ,knots = 49.5, degree = 1)+ Foreign_vs_Sweden + Foreign_vs_Sweden:Letter_received,
...
model_interaction_Education_for_Robust_High <- car::linearHypothesis(model_simple_Kernels_Country_Abroad_High,
                                                                     c(
...
pvalue_interaction_country_for_Robust_high <- model_interaction_Education_for_Robust_High[2,'Pr(>Chisq)']
...
model_simple_Kernels_Country_Abroad_LM_design <- svydesign(id = ~ 1, data = main_data_tbl_logit %>% 
                                                           ...
                                                           weights =  ~ weights_4_model) 
model_simple_Kernels_Country_Abroad_LM <- svyglm(Vax_within_90  ~ Letter_received +  bs(age_formula_influencer ,knots = 49.5, degree = 1)+ Foreign_vs_Sweden + Foreign_vs_Sweden:Letter_received,
...
model_interaction_Education_for_Robust_LM <- car::linearHypothesis(model_simple_Kernels_Country_Abroad_LM,
                                                                   c(
                                                                     'Letter_received:Foreign_vs_SwedenSweden',
                                                                     'Letter_received:Foreign_vs_SwedenAbroad_High'),
                                                                   cluster=NULL,
...
pvalue_interaction_country_for_Robust_low <- model_interaction_Education_for_Robust_LM[2,'Pr(>Chisq)']
...
results_Birth_Country <- data.frame(
  Model = c('Born_Sweden','Born_AbroadHigh','Born_AbroadLow'),
...
main_data_tbl_sum_90_Country <- main_data_tbl %>% 
  filter(Vax_within_90 == 'Yes') %>% 
  group_by(Letter_received, Birth_year_influencer, Birth_month_influencer, BirthYM_Cat_influencer, Foreign_vs_Sweden) %>% 
  summarize(pop_vaxed = n()) %>% 
  ungroup()

pop_per_month_cat_country$BirthYM_Cat_influencer <- as.character(pop_per_month_cat_country$BirthYM_Cat_influencer)
main_data_tbl_sum_90_Country$BirthYM_Cat_influencer <- as.character(main_data_tbl_sum_90_Country$BirthYM_Cat_influencer)


main_data_tbl_sum_90_Country <- main_data_tbl_sum_90_Country %>% 
  left_join(pop_per_month_cat_country, by = c('Foreign_vs_Sweden','BirthYM_Cat_influencer'))
...
main_data_tbl_sum_90_Country$BirthYM_Cat_influencer <- factor(main_data_tbl_sum_90_Country$BirthYM_Cat_influencer)#,
...
ggplot(main_data_tbl_sum_90_Country, aes(x = age_formula_influencer,
                                         y = prop_vaxed, 
                                         fill = Letter_received,
                                         color = Letter_received)) +
  geom_vline(xintercept = 49.5) +
  ...
  geom_smooth(data = filter(main_data_tbl_sum_90_Country, Birth_year_influencer <= 1971), method = "lm") +
  geom_smooth(data = filter(main_data_tbl_sum_90_Country, Birth_year_influencer > 1971), method = "lm") +
...
Design_model_educ_sex_Univ_M <- svydesign(id = ~ 1, data = main_data_tbl_logit %>% 
                                          ...
                                          weights =  ~ weights_4_model) 
model_educ_sex_Univ_M <- svyglm(Vax_within_90  ~ Letter_received +  bs(age_formula_influencer ,knots = 49.5, degree = 1)+ Educ_sex + Educ_sex:Letter_received,
...
Design_model_educ_sex_Univ_F <- svydesign(id = ~ 1, data = main_data_tbl_logit %>% 
                                          ...
                                          weights =  ~ weights_4_model) 
model_educ_sex_Univ_F <- svyglm(Vax_within_90  ~ Letter_received +  bs(age_formula_influencer ,knots = 49.5, degree = 1)+ Educ_sex + Educ_sex:Letter_received,
...
Design_model_educ_sex_Gymns_M <- svydesign(id = ~ 1, data = main_data_tbl_logit %>% 
                                           ...
                                           weights =  ~ weights_4_model) 
model_educ_sex_Gymns_M <- svyglm(Vax_within_90  ~ Letter_received +  bs(age_formula_influencer ,knots = 49.5, degree = 1)+ Educ_sex + Educ_sex:Letter_received,
...
Design_model_educ_sex_Gymns_F <- svydesign(id = ~ 1, data = main_data_tbl_logit %>% 
                                           ...
                                           weights =  ~ weights_4_model) 
model_educ_sex_Gymns_F <- svyglm(Vax_within_90  ~ Letter_received +  bs(age_formula_influencer ,knots = 49.5, degree = 1)+ Educ_sex + Educ_sex:Letter_received,
...
Design_model_educ_sex_Primr_M <- svydesign(id = ~ 1, data = main_data_tbl_logit %>% 
                                           ...
                                           weights =  ~ weights_4_model) 
model_educ_sex_Primr_M <- svyglm(Vax_within_90  ~ Letter_received +  bs(age_formula_influencer ,knots = 49.5, degree = 1)+ Educ_sex + Educ_sex:Letter_received,
...
Design_model_educ_sex_Primr_F <- svydesign(id = ~ 1, data = main_data_tbl_logit %>% 
                                           ...
                                           weights =  ~ weights_4_model) 
model_educ_sex_Primr_F <- svyglm(Vax_within_90  ~ Letter_received +  bs(age_formula_influencer ,knots = 49.5, degree = 1)+ Educ_sex + Educ_sex:Letter_received,
...
main_data_tbl_sum_90_Education_sex <- main_data_tbl %>% 
  filter(Vax_within_90 == 'Yes') %>% 
  group_by(Letter_received, Birth_year_influencer, Birth_month_influencer, BirthYM_Cat_influencer, Educ_sex) %>% 
  summarize(pop_vaxed = n()) %>% 
  ungroup() 

pop_per_month_cat_education_sex$BirthYM_Cat_influencer <- as.character(pop_per_month_cat_education_sex$BirthYM_Cat_influencer)
main_data_tbl_sum_90_Education_sex$BirthYM_Cat_influencer <- as.character(main_data_tbl_sum_90_Education_sex$BirthYM_Cat_influencer)


main_data_tbl_sum_90_Education_sex <- main_data_tbl_sum_90_Education_sex %>% 
  left_join(pop_per_month_cat_education_sex, by =c('Educ_sex','BirthYM_Cat_influencer'))
...
main_data_tbl_sum_90_Education_sex$BirthYM_Cat_influencer <- factor(main_data_tbl_sum_90_Education_sex$BirthYM_Cat_influencer)#, 
...
ggplot(main_data_tbl_sum_90_Education_sex, aes(x = age_formula_influencer,
                                               y = prop_vaxed, 
                                               fill = Letter_received,
                                               color = Letter_received)) +
  geom_vline(xintercept = 49.5) +
  ...
  geom_smooth(data = filter(main_data_tbl_sum_90_Education_sex, Birth_year_influencer <= 1971), method = "lm") +
  geom_smooth(data = filter(main_data_tbl_sum_90_Education_sex, Birth_year_influencer > 1971), method = "lm") +
...
rd_analysis_country_Abroad_LM <- rdrobust(y = main_data_tbl_logit_Abroad_LM$Vax_within_90,
                                          x = main_data_tbl_logit_Abroad_LM$age_formula_influencer, 
                                          c = 49.5, 
                                          h = selected_bandwidth_imbens,
                                          p = 1, # 1 for linear regression
                                          kernel = 'epanechnikov')
...
rd_analysis_country_Abroad_High <- rdrobust(y = main_data_tbl_logit_Abroad_High$Vax_within_90,
                                            x = main_data_tbl_logit_Abroad_High$age_formula_influencer, 
                                            c = 49.5,
                                            h = selected_bandwidth_imbens,
                                            p = 1, # 1 for linear regression
                                            kernel = 'epanechnikov')
...
rd_analysis_country_Sweden <- rdrobust(y = main_data_tbl_logit_Sweden$Vax_within_90,
                                       x = main_data_tbl_logit_Sweden$age_formula_influencer, 
                                       c = 49.5,
                                       h = selected_bandwidth_imbens,
                                       p = 1, # 1 for linear regression
                                       kernel = 'epanechnikov')
...
results_table_Country_rdrobust <- data.frame(
  Model = c('rdrobust','Born_Sweden', 'Born_AbroadHigh', 'Born_AbroadLow'),
  Coeff = c(coeff_main_rd,sweden_country_beta, high_country_beta, low_country_beta),
  CI_L = c(CI95_low_main_rd,CI95_low_Sweden, CI95_low_abroad_High, CI95_low_abroad_LM),
  CI_H = c(CI95_high_main_rd,CI95_high_Sweden,CI95_high_abroad_High, CI95_high_abroad_LM),
  P = c(pvalue_main_rd,pvalue_Sweden,pvalue_abroad_High, pvalue_abroad_LM),
  P_Robust = c(pvalue_main_rd_robust,pvalue_Sweden_robust,pvalue_abroad_High_robust,pvalue_abroad_LM_robust),
  
  P_intrctn = c(NA,pvalue_country_rd,pvalue_country_rd,pvalue_country_rd),
  
  nm_obs = c(nm_obs_rdrobust,nm_obs_rdrobust_Sweden,nm_obs_rdrobust_High, nm_obs_rdrobust_LM),
  bandwidth = c(selected_bndwdth_rdrob,selected_bndwdth_rdrob_Sweden,selected_bndwdth_rdrob_High,selected_bndwdth_rdrob_LM),
  bndw_bias_correct = c(selected_bndwdth_Bias_Corrected_rdrob,selected_bndwdth_Bias_Corrected_rdrob_Sweden,selected_bndwdth_Bias_Corrected_rdrob_High, selected_bndwdth_Bias_Corrected_rdrob_LM)
...
rd_analysis_Primr_F <- rdrobust(y = main_data_tbl_logit_Primr_F$Vax_within_90,
                                x = main_data_tbl_logit_Primr_F$age_formula_influencer, 
                                c = 49.5,
                                h = selected_bandwidth_imbens,
                                p = 1, # 1 for linear regression
                                kernel = 'epanechnikov')
...
rd_analysis_Primr_M <- rdrobust(y = main_data_tbl_logit_Primr_M$Vax_within_90,
                                x = main_data_tbl_logit_Primr_M$age_formula_influencer, 
                                c = 49.5,
                                h = selected_bandwidth_imbens,
                                p = 1, # 1 for linear regression
                                kernel = 'epanechnikov')
...
rd_analysis_Gymns_F <- rdrobust(y = main_data_tbl_logit_Gymns_F$Vax_within_90,
                                x = main_data_tbl_logit_Gymns_F$age_formula_influencer, 
                                c = 49.5,
                                h = selected_bandwidth_imbens,
                                p = 1, # 1 for linear regression
                                kernel = 'epanechnikov')
...
rd_analysis_Gymns_M <- rdrobust(y = main_data_tbl_logit_Gymns_M$Vax_within_90,
                                x = main_data_tbl_logit_Gymns_M$age_formula_influencer, 
                                c = 49.5,
                                h = selected_bandwidth_imbens,
                                p = 1, # 1 for linear regression
                                kernel = 'epanechnikov')
...
rd_analysis_Univ_F <- rdrobust(y = main_data_tbl_logit_Univ_F$Vax_within_90,
                               x = main_data_tbl_logit_Univ_F$age_formula_influencer, 
                               c = 49.5,
                               h = selected_bandwidth_imbens,
                               p = 1, # 1 for linear regression
                               kernel = 'epanechnikov')
...
rd_analysis_Univ_M <- rdrobust(y = main_data_tbl_logit_Univ_M$Vax_within_90,
                               x = main_data_tbl_logit_Univ_M$age_formula_influencer, 
                               c = 49.5,
                               h = selected_bandwidth_imbens,
                               p = 1, # 1 for linear regression
                               kernel = 'epanechnikov')
